/*
  Example of code to emulate a  1K-Bit protected 1-Wire EEPROM (DS2431) on the Arduino Nano as a slave.  
 ...
 the following code simulates a DS2431 chip as a 1-Wire slave  and writes data into the main memory    
...
void setup() {
  ...
  Serial.println("Write Hex Data to the first DS2431 (ds2431)");
  ...
  ds2431.writeMemory(memory,sizeof(memory),0x00);
  ...
  ds2431.writeMemory(mem_1, sizeof(mem_1), 1*32);
  ...
  ds2431.writeMemory(mem_2, sizeof(mem_2), 2*32);  
  ...
  ds2431.writeMemory(mem_3, sizeof(mem_3), 3*32);  
